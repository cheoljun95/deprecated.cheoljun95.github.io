...
Our team built a novel HRI platform where users can interact with the robot by hand gestures. The lack of interaction with robots is one of the major sources of users' low confidence in robots.
